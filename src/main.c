...
int main(){
    ...
    addProduct(theProvider, create_product(manufacturer1));
    addProduct(theProvider, create_product(manufacturer2));
    addProduct(theProvider, create_product(manufacturer3));
    addProduct(theProvider, create_product(manufacturer4));
    addProduct(theProvider, create_product(manufacturer5));
